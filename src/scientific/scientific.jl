...
- `ax` Given axis
- `lr` Linear regression object from EmeraldMath.Regression
...
"""
function plot_line_regress!(ax::PyObject, lr; linestyle::String = "-", interval::Bool = false, color::String = "red", alpha::Number = 0.3)
